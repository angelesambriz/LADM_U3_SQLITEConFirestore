...
class MainActivity : AppCompatActivity() {
    ...
    private fun cargarContactos() {
        try {
            ...
            //Consulta con todas las personas con todas las columnas,no lleva where
            ...
            listacontactos.adapter = ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, personas)

            listacontactos.setOnItemClickListener { adapterView, view, posicionItemSeleccionado, id ->
    ...
    fun consulta() {
        try {
            ...
            var cursor = transaccion.query("APARTADO", arrayOf("NOMBRE","PRODUCTO", "PRECIO"),"ID=?",
            ...
            if (cursor.moveToFirst()){
                ...
                baseRemota.collection("pedidos").add(datosInsertar)
